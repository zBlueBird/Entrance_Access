...
void OLED_ShowEnter32x32(uint8_t x, uint8_t y, uint8_t no)
{
    ...
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no][t], OLED_DATA);
        adder += 1;
    }
    OLED_Set_Pos(x + 16, y);
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no + 1][t], OLED_DATA);
        adder += 1;
    }
    ...
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no + 2][t], OLED_DATA);
        adder += 1;
    }
    OLED_Set_Pos(x + 16, y + 1);
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no + 3][t], OLED_DATA);
        adder += 1;
    }
    ...
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no + 4][t], OLED_DATA);
        adder += 1;
    }
    OLED_Set_Pos(x + 16, y + 2);
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no + 5][t], OLED_DATA);
        adder += 1;
    }
    ...
    for (t = 0; t < 16; t++)
    {
        OLED_WR_Byte(enter_allowed_arr[8 * no + 6][t], OLED_DATA);
        adder += 1;
    }
    OLED_Set_Pos(x + 16, y + 3);
    for (t = 0; t < 16; t++)
    {
