...
#define cs_reset()                  GPIO_ResetBits(GPIOA, GPIO_Pin_4)//HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET)
#define cs_set()                        GPIO_SetBits(GPIOA, GPIO_Pin_4)//HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_SET)
